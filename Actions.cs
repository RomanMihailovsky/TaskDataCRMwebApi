...
namespace CrmEarlyBound
{
	...
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("new_MyCustomAction")]
	public partial class new_MyCustomActionRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		...
		public string InputParam
		{
			get
			{
				if (this.Parameters.Contains("InputParam"))
				{
					return ((string)(this.Parameters["InputParam"]));
				}
				else
				{
					return default(string);
			...
			set
			{
				this.Parameters["InputParam"] = value;
			}
		}
		...
		public string LeadId
		{
			get
			{
				...
				{
					return ((string)(this.Parameters["LeadId"]));
				}
				else
				{
					return default(string);
		...
		public new_MyCustomActionRequest()
		{
			this.RequestName = "new_MyCustomAction";
		}
	}
	
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("new_MyCustomAction")]
	public partial class new_MyCustomActionResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		
		public new_MyCustomActionResponse()
		{
		}
		
		public Microsoft.Xrm.Sdk.EntityCollection OutputParameter
		{
			get
			{
				if (this.Results.Contains("OutputParameter"))
				{
					return ((Microsoft.Xrm.Sdk.EntityCollection)(this.Results["OutputParameter"]));
				}
				else
				{
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("new_MyCustomActionInterest")]
	public partial class new_MyCustomActionInterestRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		...
		public new_MyCustomActionInterestRequest()
		{
			this.RequestName = "new_MyCustomActionInterest";
			this.Target = default(Microsoft.Xrm.Sdk.EntityReference);
		}
	}
	
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("new_MyCustomActionInterest")]
	public partial class new_MyCustomActionInterestResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		
		public new_MyCustomActionInterestResponse()
		{
		}
		
		public Microsoft.Xrm.Sdk.EntityReference OutputParameter
		{
			get
			{
				if (this.Results.Contains("OutputParameter"))
				{
					return ((Microsoft.Xrm.Sdk.EntityReference)(this.Results["OutputParameter"]));
				}
				else
				{
					return default(Microsoft.Xrm.Sdk.EntityReference);
	...
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.RequestProxyAttribute("new_CustomActionLead")]
	public partial class new_CustomActionLeadRequest : Microsoft.Xrm.Sdk.OrganizationRequest
	{
		...
		public new_CustomActionLeadRequest()
		{
			this.RequestName = "new_CustomActionLead";
			this.Target = default(Microsoft.Xrm.Sdk.EntityReference);
		}
	}
	
	[System.Runtime.Serialization.DataContractAttribute(Namespace="http://schemas.microsoft.com/xrm/2011/new/")]
	[Microsoft.Xrm.Sdk.Client.ResponseProxyAttribute("new_CustomActionLead")]
	public partial class new_CustomActionLeadResponse : Microsoft.Xrm.Sdk.OrganizationResponse
	{
		
		public new_CustomActionLeadResponse()
		{
		}
